...
class Recibo(db.Model):
    ...
    impreso = db.Column(db.Boolean,nullable=False,default=0)
    created_at = db.Column(db.DateTime,nullable=False,default=datetime.utcnow)

    padron = db.relationship("PadronElectoral",backref="recibos")
    eleccion = db.relationship("Eleccion",backref="recibos")